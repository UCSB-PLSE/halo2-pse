...
#[allow(dead_code)]
#[derive(Debug)]
pub struct SimpleCircuitCost<G: PrimeGroup, ConcreteCircuit: Circuit<G::Scalar>> {
...
impl<G: PrimeGroup, ConcreteCircuit: Circuit<G::Scalar>> SimpleCircuitCost<G, ConcreteCircuit> {
...
mod tests {
    ...
    fn circuit_cost_without_permutation() {
        ...
        let x = SimpleCircuitCost::<Eq, MyCircuit>::measure(K, &MyCircuit);
        println!("Total number of columns: {}", x.num_total_columns);
    }
}
